...
##### Save cleaned data#####
############################
saveRDS(dat, "data/afdb_clusters.RDS")
saveRDS(afdb_taxonomy, "data/afdb_cluster_taxonomy.RDS")
saveRDS(cluster_stats, "data/afdb_cluster_stats.RDS")
saveRDS(tree, "data/timetree_phylogeny_cleaned.RDS")
saveRDS(tree_taxonomy, "data/timetree_taxonomy.RDS")
saveRDS(pdb, "data/pdb_metadata.RDS")
saveRDS(pdb_taxonomy, "data/pdb_taxonomy.RDS")
saveRDS(genome_stats, "data/afdb_genome_size_stats.RDS")
